...
def print_death_age(people_dict):
    ...
    for item in people_dict.items():
        person_list = item [1]
        print (f'{person_list[NAME_INDEX]} {int(person_list[DEATH_YEAR_INDEX]) - int(person_list[BIRTH_YEAR_INDEX])}')
...
def print_marriages(marriages_dict, people_dict):
    ...
    for item in marriages_dict.items():
        marriage_list = item[1]
        person_list = people_dict[marriage_list[HUSBAND_KEY_INDEX]]
        wife_list = people_dict [marriage_list [WIFE_KEY_INDEX]]
        
        print (f'{person_list[NAME_INDEX]} {int(marriage_list[WEDDING_YEAR_INDEX]) - int(person_list[BIRTH_YEAR_INDEX])} > {marriage_list[WEDDING_YEAR_INDEX]}  < {wife_list[NAME_INDEX]} {int(marriage_list[WEDDING_YEAR_INDEX]) - int(wife_list[BIRTH_YEAR_INDEX])}')
